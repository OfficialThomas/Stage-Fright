class Play extends Phaser.Scene {
    ...
    create(){
        ...
        this.p1.setScale(5);
        this.e1 = new Enemy(this, game.config.width/2 + borderPadding*20, game.config.height/2 - borderPadding*4, 'hearthalf', 0).setOrigin(0,0);
        ...
        //lives
        this.lives = this.add.text(game.config.width, game.config.height - borderUISize*2, "Lives", gameConfig);
